...
//return this.each( function() { //like a real jQuery plugin: run on on each element
   if (!cl || !cl.length)
      return this;
   ...
   var defaults = {
      ...
      click: function(tag) {
      	//return javascript to call tweet-feed
   ...
   for (var i = 0; i < cl.length; ++i) {
      var tag = cl[i].tag;
      var tagEl = jQuery('<a href="" class="tagcloudlink" style="line-height: 0.85em; font-size: '
